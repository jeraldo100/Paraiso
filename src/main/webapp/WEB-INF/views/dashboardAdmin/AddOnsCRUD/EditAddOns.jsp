        ...
        <div class="card-body">
          <form action="/admin/updateAddOns/${addOns.add_on_id }" method="post">
            ...
            <div class="form-group">
              ...
              <input type="text" name="description" id="description" placeholder="Enter Check In date" class="form-control" />
            </div>
            <div class="form-group">
              <label>Amount :</label>
              <input type="number" name="amount" id="amount" placeholder="Enter Check Out date" class="form-control" />
            </div>
