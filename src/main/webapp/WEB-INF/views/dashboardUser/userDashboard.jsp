...
<link rel="icon" type="image/png" sizes="16x16 32x32"
	href="/images/logo/paraisologo2.png">
														...
														<c:choose>
															...
															<c:when test="${booking.status == 'Approved'}">
																...
																<button type="button" data-bs-toggle="modal"
																	...
																	class="payment-button btn btn-success">Pay</button>
															</c:when>
															...
															<c:otherwise>
																...
																<div>
																	<a href="/jasperReportItinerary/${booking.booking_id}"
																		class="btn btn-success" data-dismiss="modal">Print
																		Itinerary</a>
																</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="payment-content">
						<div hidden id="payment-price-hidden">
							<!-- hidden price -->
						</div>
						...
						<div class="payment-options">
							<div class="payment-option">
								<input checked type="radio" class="payment-radio" id="Gcash"
									name="payment-method" value="Gcash"> <label>Gcash</label>
							</div>
							<div class="payment-option">
								<input type="radio" class="payment-radio" id="CardPayment"
									name="payment-method" value="CreditOrDebitCard"> <label>Credit/Debit
									Card</label>
							</div>
							<div class="payment-option">
								<input type="radio" class="payment-radio" id="Paymaya"
									name="payment-method" value="Paymaya"> <label>Paymaya</label>
							</div>
							<div id="payment-fields">
								<img style="height: 3rem; object-fit: cover;"
									src="/images/logo/gcashLogo.png" />
