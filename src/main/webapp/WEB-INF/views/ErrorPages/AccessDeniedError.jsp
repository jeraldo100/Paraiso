...
<head>
    ...
    <title>Error Page</title>
       <link rel="stylesheet" href="/styles/AccessDeniedError.css" />
</head>
<body>
    <div class="container">
        <div class="error">
            ...
            <h2>Access Denied</h2>
        	<p>You don't have permission to access this page, but no worries! Let me help you find <a href="/home">a way out</a>.</p>
       </div>
   ...
   <script src="/scripts/AccessDeniedError.js"></script>
</body>
</html>