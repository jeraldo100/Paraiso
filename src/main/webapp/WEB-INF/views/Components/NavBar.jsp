...
<body>
							...
							<c:when test="${loggedIn}">
								<li class="menu-has-children"><a
									class=" fa-solid fa-user text-white"><i
										class="fa-solid fa-chevron-down ml-1"></i></a>
									<ul>
										<div class="container">
											<div
												class="row justify-content-center align-items-center text-center mb-2 mt-2">
												<div class="col-12">
													<img src="/images/NavBar/profile-icon.png"
										...
										<li><a
											href="${accountType == 'ADMIN' ? '/admin/AdminDashboard' : '/user/userProfile'}">Dashboard</a></li>
		...
		<div id="loginModal" class="login-signup-modal">
			<div class="login-container">
				...
				<div class="signin-signup">
					<form id="loginForm" class="sign-in-form" action="auth"
						method="post">
						...
						<input href="register" type="submit" value="Submit"
					...
					<form id="registrationForm" action="registration" method="post"
						...
						<div class="column-container">
							...
							<div class="signup-input signup-col2">
								<i class="fas fa-user"></i> <input type="text" name="lastName"
						...
						<div class="column-container">
							<div class="signup-input signup-col1">
								<i class="fa-solid fa-calendar"></i> <input type="text"
									name="dateOfBirth" id="dateOfBirth" placeholder="Date of Birth"
									max="" onfocus="(this.type='date')" />
							</div>
						...
						<p class="account-text">
							Already have an account? <a href="#" id="sign-in-btn2">Sign
								in</a>
						</p>
					</form>
				</div>
				...
				<div class="panels-container">
					<div class="login-signup-panel left-panel">
						<div class="login-signup-content">
							...
							<p>Log in to your account to enjoy the ease of tracking your
								bookings, receiving tailored recommendations, and unlocking
								special offers reserved for our members.</p>
							<button class="login-signup-btn" id="sign-in-btn">Login</button>
						</div>
						<img src="/images/LoginSignUp/signin.svg" alt=""
							class="login-signup-image" />
					</div>
					<div class="login-signup-panel right-panel">
						<div class="login-signup-content">
							<h3>New here? Join us by signing up</h3>
							<p>Sign up today to receive personalized offers, access
								exclusive deals, and enjoy a faster Paraiso Hotel booking
								experience.</p>
							<button class="login-signup-btn" id="sign-up-btn">Sign
								up</button>
						</div>
						<img src="/images/LoginSignUp/signup.svg" alt=""
							class="login-signup-image" />
					</div>
				</div>
			</div>
	...
	<script
		src="https://cdnjs.cloudflare.com/ajax/libs/superfish/1.7.10/js/superfish.min.js"></script>
