                                            ...
                                            <div class="half right-arrow d-flex">
                                                <div class="text p-4" style="margin: 0 25px; margin-top: 20px">
                                                    ...
                                                    <p class="pt-1 d-md-flex align-items-center justify-content-center">
                                                        <a href="/roomdetail/${room_type.type_id}"
                                                            class="btn-custom px-3 py-2 rounded">View Details <span
                                                                class="icon-long-arrow-right"></span></a>
                                                    </p>
                                                </div>
                                            </div>
                                            <a href="#" class="img room-img"
                                                style="background-image: url(data:image/jpeg;base64,${Base64.getEncoder().encodeToString(room_type.roomImage)}"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
